  ...
  return (
    <div className="min-h-screen bg-[#0a0c10] text-white relative overflow-hidden flex flex-col lg:flex-row">
      ...
      <motion.aside
        ...
        className="fixed lg:static left-0 top-0 bottom-0 w-64 bg-slate-900/80 backdrop-blur-xl border-r border-white/5 z-40 h-screen overflow-y-auto shrink-0 flex flex-col justify-between"
      >
        <div className="p-6">
