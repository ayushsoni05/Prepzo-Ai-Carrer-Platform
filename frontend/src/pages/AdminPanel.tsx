  ...
  return (
    <div className="min-h-screen bg-[#0a0c10] text-white relative overflow-hidden flex flex-col lg:flex-row">
      ...
      <motion.aside
        ...
        className={`fixed left-0 top-0 bottom-0 z-40 h-screen overflow-y-auto overflow-x-hidden shrink-0 flex flex-col justify-between transition-all duration-300 ease-in-out bg-[#0a0c10]/80 backdrop-blur-xl border-r border-white/5 ${
          isSidebarHovered ? 'w-64' : 'w-64 lg:w-20'
        }`}
      >
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8 overflow-hidden">
            ...
            <div className={`transition-all duration-300 ${isSidebarHovered ? 'opacity-100 translate-x-0' : 'lg:opacity-0 lg:-translate-x-10 pointer-events-none'}`}>
              <span className="text-xl font-bold whitespace-nowrap">Admin</span>
              <p className="text-xs text-gray-400 whitespace-nowrap">Prepzo Panel</p>
            </div>
          </div>
          ...
          <nav className="space-y-1">
            {sidebarItems.map((item) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all overflow-hidden ${
                  activeTab === item.id
              ...
              >
                ...
                <span className={`transition-all duration-300 whitespace-nowrap ${isSidebarHovered ? 'opacity-100 translate-x-0' : 'lg:opacity-0 lg:-translate-x-10'}`}>
                  {item.label}
                </span>
              </button>
            ))}
        ...
        <div className="p-6">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-red-500/10 hover:text-red-400 transition-all text-sm font-semibold overflow-hidden"
          >
      ...
      {/* Desktop sidebar spacer to reserve space for collapsed sidebar */}
      <div className="hidden lg:block lg:w-20 shrink-0 transition-all duration-300" />
