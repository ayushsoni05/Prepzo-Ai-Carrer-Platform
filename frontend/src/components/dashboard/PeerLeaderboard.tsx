...
export function PeerLeaderboard({
  ...
  return (
    <div className="rounded-[40px] p-8 bg-black/40 border border-white/5 shadow-2xl relative overflow-hidden group hover:border-[#5ed29c]/20 transition-all duration-500 h-full font-rubik">
